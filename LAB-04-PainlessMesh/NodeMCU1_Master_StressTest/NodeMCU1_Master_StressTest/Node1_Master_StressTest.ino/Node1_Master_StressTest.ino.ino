...
// Test parameters
const int baudRates[] = {115200};
//const int baudRates[] = {9600, 38400, 230400, 250000};

const int messageSizes[] = {100, 50, 10};
//const int intervals[] = {0, 10, 100}; // Delay in ms

const int intervals[] = {100, 100, 10}; // Delay in ms
...
void loop() {
  ...
  for (int baud : baudRates) {
    ...
    delay(1000); // Allow NodeMCU 2 to sync baud rate
